...
## zab_package içerisindeki zab_p70 programım üzerinden veya $tmp(local) içerisindeki ZTYU programım üzerinden Projeme Erişebilirsiniz(se38 ekranında ZTYU yazarak).
